	...
	$(function() {
		...
		var _do_facebook_connect = function() {
			...
			if(client_id == "") {
				...
				window.open('https://graph.facebook.com/oauth/authorize?client_id=' + client_id + '&redirect_uri=' + redirect_uri + '&scope=email,user_hometown,user_location',
...
window.wp_social_connect = function(config) {
	...
	if(!jQuery('#loginform').length) {
		...
		if(jQuery('#registerform').length) {
			...
			jQuery('#loginform').append("<input type='hidden' id='redirect_to' name='redirect_to' value='edit-profile/'>");
		}
	}
